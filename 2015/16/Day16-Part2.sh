...
# cats and trees are greater
# while the pomeranians and goldfish are fewer
...
# Filter for 'cats: 8 or greater' or lines without 'cats'
cat 1.txt | grep -v 'cats' > 2.txt
cat 1.txt | grep 'cats: 8' >> 2.txt
cat 1.txt | grep 'cats: 9' >> 2.txt
cat 1.txt | grep 'cats: 10' >> 2.txt
...
# Filter for 'pomeranians: 2 or less' or lines without 'pomeranians'
cat 3.txt | grep 'pomeranians: 2' > 4.txt
cat 3.txt | grep 'pomeranians: 1' >> 4.txt
...
# Filter for 'goldfish: 4 or fewer' or lines without 'goldfish'
cat 6.txt | grep -v 'goldfish' > 7.txt
cat 6.txt | grep 'goldfish: 4' >> 7.txt
cat 6.txt | grep 'goldfish: 3' >> 7.txt
cat 6.txt | grep 'goldfish: 2' >> 7.txt
cat 6.txt | grep 'goldfish: 1' >> 7.txt

# Filter for 'trees: 4 or greater' or lines without 'trees'
cat 7.txt | grep -v 'trees' > 8.txt
cat 7.txt | grep 'trees: 4' >> 8.txt
cat 7.txt | grep 'trees: 5' >> 8.txt
cat 7.txt | grep 'trees: 6' >> 8.txt
cat 7.txt | grep 'trees: 7' >> 8.txt
cat 7.txt | grep 'trees: 8' >> 8.txt
cat 7.txt | grep 'trees: 9' >> 8.txt
cat 7.txt | grep 'trees: 10' >> 8.txt


# Filter for 'perfumes: 1' or lines without 'perfumes'
cat 8.txt | grep 'perfumes: 1' | grep -v 'perfumes: 10' > final_output.txt
cat 8.txt | grep -v 'perfumes' >> final_output.txt

# 241 is the correct answer
