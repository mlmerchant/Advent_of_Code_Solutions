...
def count_abba_lines(challenge):
    ...
    for line in challenge:
        ...
        for i in range(len(line) - 3):
            ...
            if segment[0] == segment[3] and segment[1] == segment[2] and segment[0] != segment[1]:
                if inside_brackets:
                    invalidated_by_brackets = True
                    break  # Invalidate if inside brackets
                else:
                    found_ABBA_outside = True

        if found_ABBA_outside and not invalidated_by_brackets:
            count += 1
