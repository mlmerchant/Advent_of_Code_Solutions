challenge = """dnwtsgywerfamfv[gwrhdujbiowtcirq]bjbhmuxdcasenlctwgh
...
def count_abba_lines(challenge):
    count = 0

    for line in challenge:
        inside_brackets = False
        found_ABA_outside = False
        found_BAB_inside = False
        inside_brackets2 = False
        ...
        for i in range(len(line) - 2):
            ...
            if segment[0] == segment[2] and segment[1] != segment[2]:
                if not inside_brackets:
                    found_ABA_outside = True
                    B1 = segment[1] 
                    A1 = segment[0] 
                    B2 = segment[1] 
                    ### look for BAB
                    for i2 in range(len(line) - 2):
                        segment2 = line[i2:i2 + 3]
                        if '[' in segment2:
                            inside_brackets2 = True
                        if ']' in segment2:
                            inside_brackets2 = False
                        if  inside_brackets2 and segment2[0] == B1 and segment2[1] == A1 and segment2[2] == B2:
                            found_BAB_inside = True
        if found_ABA_outside and found_BAB_inside:
            count += 1

    return count


result = count_abba_lines(challenge.split("\n"))


# 258 is the correct answer 
print (result)